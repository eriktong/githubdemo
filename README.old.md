...
![Pages Deploy](https://github.com/eriktong/githubdemo/actions/workflows/pages.yml/badge.svg) ![Last commit](https://img.shields.io/github/last-commit/eriktong/githubdemo) ![License](https://img.shields.io/badge/license-MIT-informational)
...
2. For CRA, ensure `"homepage": "https://eriktong.github.io/githubdemo/"` exists in `package.json`.
3. For Vite, ensure `base: "/githubdemo/"` in `vite.config.*`.
